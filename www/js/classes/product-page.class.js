    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
      <div class="card mb-3">
        ...
        <div class="card-footer d-flex justify-content-around px-0">
          ...
          <div class="ml-3">
          ${product.stock == 0 ? '<p class="text-danger font-weight-bold mt-2">Slut i lager</p>' : ` <button class=" btn btn-primary card-btn float-right " data-id="${product._id}" data-toggle="tooltip" title="Max antal av vara i varukorgen">KÖP</button>` }
